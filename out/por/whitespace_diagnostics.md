...
### "Mova" + "m" (5 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Movam essas bundas suas bolas estúpidas!
...
### "de" + "Ies" (3 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Não gosta deIes?
  - Preciso deIes.
  - Um deIes vai desistir.
...
### "," + "Angela" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Como vai,Angela?
  - Por que mente,Angela?
...
- Actual: None
- Examples:
  - Agora,ele a multlpllca um mllhão de vezes.
  - De Mussollnl,ele roubou a saudação fasclsta.
...
- Actual: None
- Examples:
  - EIa estará mais segura em seu Iugar.
  - EIa sempre sai quando eu estou aqui.
...
- Examples:
  ...
  - Eu quis fazê-Io um intérprete, agora eIe está no comando de um bataIhão.

### "e" + "Ies" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Acredite, eIes estão dirigindo devagar.
  - São eIes.

### "falar" + "com" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Preciso falarcom você.
  - Terá que falarcom Frankfurt.
...
### "," + "Calcifer" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tudo bem,Calcifer, vamos cozinhar.
...
- Actual: None
- Examples:
  - A irmã caçula de Rika,a vítima de assassinato, está aqui.

### "," + "acredito" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Slm,acredito.
...
- Actual: None
- Examples:
  - Estudantes,asslm como soldados, obedecem às ordens do Führer.

### "," + "baby" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - O mesmo digo eu ,baby Onde está?
...
- Actual: None
- Examples:
  - Sim,com certeza deve ter.

### "," + "comande" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Führer,comande!
...
- Actual: None
- Examples:
  - Verão,os Senhores,como vocês chamam, não são fáceis de entender.
...
- Actual: None
- Examples:
  - Tinha acabado de voltar,depois de dez anos morando fora do país.

### "," + "desculpe" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Oh,desculpe-me.
...
- Actual: None
- Examples:
  - Qualquercultura,exceto a nazlsta,deve ser destruída.

### "," + "devia" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Como Mestre,devia ter vergonha de magoar o meu discipulo.

### "," + "ela" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quando ela chegou,ela chorava sem parar, como um bebê recém-nascido.
...
- Actual: None
- Examples:
  - Preclso lr,espere-me emmlnhacaslnha.

### "," + "estamos" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Os Piemontese nos cercam,estamos perdidos!

### "," + "estavam" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - No entanto,quando puxaram asredes,estavamchelas.

### "," + "excelência" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Bem,excelência.

### "," + "exceto" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Qualquercultura,exceto a nazlsta,deve ser destruída.
...
- Actual: None
- Examples:
  - Não viu a descrição do assassino,idiota?

### "," + "informaste" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: None
- Examples:
  - Com gosto,lutarei por quem amo.
...
- Actual: None
- Examples:
  - JurelàNossaSenhora,meu fllho.

### "," + "muito" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Graças,muito obrigado tio.
...
### "," + "promete" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quando sair daqui,promete que deixas crescer o cabelo?
...
### "," + "querida" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Oh,querida Margherita!

### "," + "rapido" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Vamos,rapido, suba!
...
### "," + "segulrelseuconselho" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Estábem,segulrelseuconselho.
...
- Actual: None
- Examples:
  - Vou às montanhas,sobre Ficuzza.

### "," + "somente" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - No final, de toda minha unidade,somente eu retornei.

### "," + "tudo" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - E depois,tudo voltará a ser como sempre.
...
- Actual: Space
- Examples:
  - HÁ UM ESPlÃO - ABORTAR.

### "-" + "Arseni" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: Space
- Examples:
  - Atropelamos o veado e a pata - Como se diz?
...
- Actual: Space
- Examples:
  - Estava em EVP -estado vegetativo persistente- como Lydia.
...
- Actual: Space
- Examples:
  - Diga - eu posso ver isso rapidinho?
...
### "Aksuml" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - E nós no obelisco de Aksuml -Ahl Você ainda está assim?
...
### "Coronel Julyan" + "?" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Seremos necessários na inquirição, Coronel Julyan ?

### "DIRETORA" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - DIRETORA -Corta!
...
### "Dire¡" + "adeus" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Dire¡ adeus a ela por você.
...
- Actual: None
- Examples:
  - EIe nunca pegará um ruim.

### "ESPlÃO" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - HÁ UM ESPlÃO - ABORTAR.
...
### "Engraçado" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Engraçado -Ele achou engraçado.
...
### "IMPACTOS" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - HAVERÁ OUTROS IMPACTOS - Meu Deus!

### "INDISCRIMINADA" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - VIOLÊNCIA INDISCRIMINADA - Não, eles irão se machucar.

### "Ienha" + "?" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Nunca viu aIguém cortar Ienha ?
...
- Actual: Space
- Examples:
  - BANKSY ATACA O MET -É uma enorme quebra de segurança.
...
- Actual: None
- Examples:
  - Masm vou enviar os papéis do patrocínio.
...
- Actual: Space
- Examples:
  - Ok -Não diga Ok, se não me acredita.
...
### "Quem" + "escapará" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quemescaparáàselvagerla?
...
### "Terranova" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Terranova - Não, seu crime não pode ser considerado o mesmo.
...
### "Todos" + "precls" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Todospreclsamsaber.

### "Trotiskistas" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Trotiskistas -Maoistas.
...
### "a" + "Igum" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Iremos para aIgum outro Iugar.
...
### "achegar" + "échlfrudo" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - VamosIOúltlmo achegaréchlfrudo!

### "acione" + "¡" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "apaixonadas" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Belas moças apaixonadas -Não, o que é isso?
...
### "doenças" + "l" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Certo, e não sabemos se trazem doençasl ou quanta radiação elas absorveram.
...
- Actual: None
- Examples:
  - Espero que compre aIgo para eIa.

### "eIes" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Você não deve ter compaixão nenhuma por eIes !
...
### "entediado" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Este é o modo como gosto dele, nunca fico entediado -Cuidado, Ogro!
...
### "ficará" + "sem" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - A cidade ficarásem diversão, sem nada!

### "fisgar" + "á" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ele não sabe o que fisgará.
...
### "guarnição" + "já" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Sua guarniçãojá está empenhada para o Cabral.
...
### "mahimahi" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Mango mahimahi -O que que tem?
...
### "mariquinhas" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - EIes são mariquinhas !
...
### "moedas" + "—" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Todos os mendigos pedem moedas—mas este tinha um propósito muito especial!

### "morrer" + "emos" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Retire-se ou todos morreremos aqui.

### "mova" + "m" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Movam-se, movam-se.
...
### "nos" + "dlstritosmllitares" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - A llstaseráaflxadaembreve nosdlstritosmllitares.
...
### "pelas" + "autorldades" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Os famIllaresserão notlflcados dlretamente pelasautorldades.
...
### "por" + "amor" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Umaloucacorrldaporouro e tambémporamor.
...
- Actual: None
- Examples:
  - Mas agora botaram o metrô, ó praí, eles cimentaram tudo.
...
### "subtitle" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Untranslated subtitle -Seis horas.
...
### "um" + "ahistóriasimples" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Estaéumahistóriasimples; no entanto,não é fácilcontá-la.
...
- Actual: None
- Examples:
  - Éverdade que ele não é um gênio, mas Amélie gosta dele.

### "à" + "selvagerla" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quemescaparáàselvagerla?
