...
- Actual: None
- Examples:
  - Mais tu ne vas pas àla synagogue, non plus.
  - Nous sommes àla méme place.
  - On fait ça àla manière douce ou àla dure, comme vous voulez.
...
- Examples:
  - NTu es vivant ?
  - NTu ne te rappelles pas du fiasco avec le gamin ?
  - NTu ne te sens pas bien ?
...
- Examples:
  - Ah oui, nique—moi ?
  - Bites—moi un chiffre.
  - Dis—moi au revoir comme quand tu étais petite.
...
- Actual: None
- Examples:
  - Dites—lui comme Milan est belle.
...
- Examples:
  - Est - ce caché ?
  - Ne serait - ce pas trop mauvais ?

### "-" + "tu" (2 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Pourquoi ne le dis - tu pas plus tôt ?
  - Que dis - tu ?
...
- Examples:
  ...
  - Je sais, mais-- -La chambre est libre maintenant.

### "Désert" + "–" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Mur météo Désert–Tundratown, porte d’accès, vite !
  - Mur météo Désert–Tundratown, porte d’accès.

### "Je" + " pense" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "me" + "prêter" (2 occurrences)
- Predicted: Space
- Actual: NarrowNbsp
- Examples:
  - Aurais-tu un vingt-cinq cennes à me prêter ?
  - Auriez-vous une pièce de vingt-cinq cents à me prêter ?
...
### " propres" + " investigations" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: None
- Examples:
  - Putain comme ils sont polis les keufs,ici !
...
- Actual: Space
- Examples:
  - N- Il a quelque chose dans la main !
...
- Actual: Space
- Examples:
  - À Marionette-Charlotte- les contrôler à distance.
...
- Actual: Space
- Examples:
  - Choc -On est pas à Thoiry, là !

### "Code rouge" + "'" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Et son pseudo-jargon militaire style 'Code rouge'.

### "Conduis" + " tes" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Conduis tes propres investigations !

### "Conduisez" + " vos" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Conduisez vos propres investigations !
...
### "Le Vieux Garçon de Greer County" + "'" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - C'était 'Le Vieux Garçon de Greer County'.

### "Les" + " jeux" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Mo" + "�emo" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Mo�emo po�eti.

### "Mon" + "appareil" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
...
- Actual: None
- Examples:
  - NBien sûr, ce serait bien.

### "N" + "Pourquoi" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - NPourquoi on-t-il coupé ?
...
- Actual: None
- Examples:
  - Passez—moi un franc àla place de souffler comme Jurassic Park.
...
### "Quel" + " parfait" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quel parfait imbécile !

### "Quelle" + " chouette" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quelle chouette famille !

### "Quelle" + " famille" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: Space
- Examples:
  - Skxawng , tu dois faire attention.
...
### "Ventre" + "s" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ventres à terre.

### "Vous" + "sa" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Voussa suivez ?
...
### "bien" + "sorties" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Je pense que nous nous en sommes bien sorties.

### "bien" + "sortis" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Je pense que nous nous en sommes bien sortis.
...
- Actual: None
- Examples:
  - Elle est au bord dela crise cardiaque, celle—là.
...
### "cette" + "école" (1 occurrences)
- Predicted: Space
- Actual: NarrowNbsp
- Examples:
  - Ma fille étudie dans cette école.

### "chahut" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Rires et chahut -Oh !
...
### "convaincant" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - H estconvaincant -Trés.
...
### "dâ€™" + "œil" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Et tout sera sec en un clin dâ€™œil.

### "déjà" + "dit" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Il a déjà dit oui.

### "déjà" + " là" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Il est déjà là.
...
### "est" + "cassé" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Mon appareil photo est cassé.

### "est" + "convaincant" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - H estconvaincant -Trés.
...
- Actual: Space
- Examples:
  - Ringo Starr a épousé une James Bond girl .
...
### "mobylette" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Moteur de mobylette -Écoute.
...
### "un" + "journal" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Je préférais tout écrire dans unjournal.
...
### "vous" + "du" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Disposez-vous du moindre alibi ?

### "vous" + "le" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Avez-vous le moindre alibi ?
...
### " au" + " lit" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tu peux retourner au lit.

### " chouette" + " famille" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quelle chouette famille !

### " famille" + " sympathique" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quelle famille sympathique !
...
### " jeux" + "olympiques" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Les jeux olympiques sont organisés tous les quatre ans.

### " ne" + " sont" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ce ne sont que balivernes.

### " organisés" + " tous" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Les jeux olympiques sont organisés tous les quatre ans.

### " parfait" + " imbécile" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Quel parfait imbécile !

### " peux" + " retourner" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tu peux retourner au lit.

### " que" + " balivernes" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ce ne sont que balivernes.

### " retourner" + " au" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tu peux retourner au lit.
...
### " sont" + " organisés" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Les jeux olympiques sont organisés tous les quatre ans.

### " sont" + " que" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ce ne sont que balivernes.

### " te" + " gares" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Où te gares-tu ?

### " tes" + " propres" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Conduis tes propres investigations !

### " tous" + " les" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Les jeux olympiques sont organisés tous les quatre ans.

### " vos" + " propres" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Conduisez vos propres investigations !
...
- Actual: Space
- Examples:
  - Comment dit-on « XXX » en portugais ?
...
### "à" + "notre" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Ce vélo appartient à notre école.

### "à" + "pied" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - John va à son bureau à pied.
...
### "à" + "votre" (1 occurrences)
- Predicted: Space
- Actual: Nbsp
- Examples:
  - Donnez-vous corps et âme à votre travail.

### "é" + "merde" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Démerde-toi !

### "également" + "allée" (1 occurrences)
- Predicted: Space
- Actual: NarrowNbsp
- Examples:
