...
### "habt" + "ja" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ihr habtja mich gefesselt.
...
### "stimmt" + "'s" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du willst es nicht wahrhaben, stimmt's?
...
- Actual: None
- Examples:
  - Ihr werdetjetzt als Verräter an eurem Vaterland betrachtet.
