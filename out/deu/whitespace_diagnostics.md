...
- Examples:
  ...
  - Der Mann stand hier, griff nach seiner Waffe und - peng!
  - Die Ballerinas trugen Ballettstrumpfhosen, -röckchen und -schuhe.

### "“" + "gesagt" (9 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Haben Sie „Import“ oder „Export“ gesagt?
...
- Examples:
  ...
  - Die Methode hat sowohl Vor- als auch Nachteile.
...
- Examples:
  - Der Terzi -Fall.
  - Die Untersuchung von mir Als Verdächtiger im Terzi -Fall?
  - Nein, ich bin hier für den Terzi -Fall.
...
### "Woll" + "t" (4 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wollt ihr Tom sagen, was er tun muß, oder soll ich?
  - Wollt ihr Tom sagen, was ihr getan habt?
  - Wollt ihr Tom und Maria sagen, was sie tun müssen, oder soll ich?
...
- Examples:
  ...
  - Schau dir das an !
  - Schaut euch die neuen Töchter an !
...
- Examples:
  ...
  - Ich weiß, was Sie auf lhrem Verstand haben - was?
...
- Examples:
  ...
  - Hast du einen Lieblingsfilm oder -Song?
  - Hattet ihr irgendwelche Schultraditionen oder -rituale?
...
- Actual: Space
- Examples:
  - Gut haben Sie einen Punkt dort - Nein, Ich hätte ihn nicht ändern können.
  - Wirklich reizte ich gerade wenig - Nein, sah ich, was geschah.

### "-" + "Tut" (2 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Es wird wehtun- Tut mir leid-.
...
- Examples:
  ...
  - Was würde der Senat mit mir anfangen - so einem Gesetzgeber?
...
- Actual: Space
- Examples:
  - Aber … Ich mein, du verstehst das.
...
- Actual: None
- Examples:
  - Da warst du gleich ganz freundlich, nicht?
  - Da warst du noch auf der Oberschule, oder?
...
- Examples:
  - Agent Starling, FBI .
  - Und wenn Ihnen das gelingt, dürfen Sie wieder zum Dienst, zum FBI .
...
### "Kriegskunst" + "“" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Sie spielt „Welt der Kriegskunst“.
  - Tom hat „Die Kriegskunst“ von Sūnzǐ gelesen.

### "Marsfahrzeug" + "“" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Das „Neugier-Marsfahrzeug“ ist auf dem Mars gelandet.
...
### "Warp" + "geschwindigkeit" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "bist" + "ja" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Aber du bistja erwachsen!
  - Du bistja eiskalt.
...
### "hast" + "ja" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du hastja auch ohne sie bestens existiert.
  - Du hastja gesund gelebt.
...
### "ist" + "jemand" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Carlos, da istjemand im Bad.
  - Für Susana istjemand am Telefon.
...
- Examples:
  - Alle waren so nett zu mir - als gehörte ich dazu.
  - Kauft Papa mir - Woher haben Sie die Nummer?
...
- Actual: Space
- Examples:
  - Nimm alle anderen Effekte raus - nur den Schrei.
  - Schaff ihn hier raus - wie, ist mir egal.

### "sehr" + "jung" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Es ist zwar sehrjung, aber ihm gehört die Zukunft.
...
- Examples:
  ...
  - Wie weit aussen wird es sein ?

### "sich" + "s" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Er sagt, er überlegt sichs.
  - Sie wollen sichs überlegen.

### "sieht" + "s" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wie siehts aus Chef?
...
- Actual: Space
- Examples:
  - Das habe ich für ’n Appel und ’n Ei bekommen.
...
### "wir" + "jetzt" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ich bin sehr froh, dass wirjetzt zusammen hier sind.
  - Was tun wirjetzt?

### "wird" + "s" (2 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Natürlich wirds das.
...
- Examples:
  - Drei, zwei - Zwei!
  - Schauen Sie doch, zwei - Spaghetti.
...
- Actual: Space
- Examples:
  - Geh mir aus dem Weg, oder ich knall’ dich ab!
...
- Examples:
  - Er hat mir gesagt, wann ich „Ja“ sagen soll.
  - Geh ihm „Auf Wiedersehen“ sagen, bevor er weg ist.
...
- Actual: None
- Examples:
  - Apuleius schrieb „Der goldene Esel“.
  - Ich habe auf der Oberschule „Der große Gatsby“ gelesen.
...
### "„Science“" + "veröffentlicht" (2 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: None
- Examples:
  - Es kann sein,dass Bosco nichts damit zu tun hat.

### "," + "ich" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Gut,ich glaube ich muss gehen.
...
- Actual: Space
- Examples:
  - Und wenn die Meise nicht will singen - Alle raus.
...
### "-" + "Beleidigung" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Der Oberleutnant war in Uniform - Beleidigung eines Offiziers.

### "-" + "Beschwerde" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Was wollen Sie denn tun, - Beschwerde einlegen?

### "-" + "Blauviolett" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich half, das Totenkleid auszusuchen - Blauviolett.

### "-" + "Cabeleiras" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - In Begleitung von Dadinho und Bené - Cabeleiras Bruder .
...
- Actual: Space
- Examples:
  - Ich mag keine Möhren - Du darfst dich nicht so anstellen.

### "-" + "Ende" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Dein Freund Richie - Ende des Briefes.
...
- Actual: Space
- Examples:
  - MILITÄREINSATZ BEI AUSSCHREITUNGEN - Es greift wohl im ganzen Land um sich.
...
### "-" + "Freddy Loyacano" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Schlagbass - Freddy Loyacano.
...
- Actual: Space
- Examples:
  - Gut, Sie zu sehen - Gut, Sie auch zu sehen.
...
- Actual: Space
- Examples:
  - Eine unschuldige Schlange … - Judy, die Luchse sind Killer.

### "-" + "Karzer" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Aktion - Reaktion - Karzer!
...
- Actual: Space
- Examples:
  - Loben Sie den Lord der Macht - Loben Sie den Lord der Macht.

### "-" + "Meine" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - GEWALTSAME UNRUHEN - Meine Güte.
...
- Actual: Space
- Examples:
  - Ja, Sir, ja, Sir, Mister Tucker - Motherfucker!
...
- Actual: Space
- Examples:
  - Ich muss - Nur eine Minute?

### "-" + "Oh" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wir haben Stromausfälle ziemlich häufig - Oh, wann nimmt es wieder auf?
...
### "-" + "Phil Douglas" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Violine - Phil Douglas.

### "-" + "Ritter" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: Space
- Examples:
  - Jetzt oder nie - Sport treiben oder duschen.

### "-" + "Stachelschwein" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "-" + "Trompete" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Max Tooney - Trompete.

### "-" + "Tschuess" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Bis dann - Tschuess.

### "-" + "Untersucht" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wird gerade im Labor untersucht … - Untersucht werden müssen Sie!

### "-" + "Vampir" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Hey, wer ist denn da - Vampir Miller!

### "-" + "Westen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: Space
- Examples:
  - Du spinnst, du tust überhaupt nichts - bleib in der verdammten Zelle!
...
### "-" + "deinem" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Das Motto der SSBS - deinem neuen Heim.
...
- Actual: Space
- Examples:
  - Den Bourbonen - falls es erlaubt ist, sie zu erwähnen.
...
- Actual: Space
- Examples:
  - Sag nicht, was dir am Wagen ge- fällt, ich will den Preis drücken.
...
- Actual: Space
- Examples:
  - Die Leute nennen dies ein Nord- gegen Südstaatenspiel.
...
- Actual: Space
- Examples:
  - Der Sänger ist Jae- ha Yu.

### "-" + "haben" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wieso - haben Sie was dagegen?
...
### "-" + "höchstpersönlich" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: Space
- Examples:
  - Das ist ihr Verbrechen - ihre betörende Schönheit.
...
- Actual: Space
- Examples:
  - Satellitäh Satelliten - lassen Sie mich erklären.
...
- Actual: Space
- Examples:
  - Entschuldigen Sie mir John - sicher, erklären Sie mir.

### "-" + "solche" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wettbewerbe damit gewonnen - solche Sachen.
...
- Actual: Space
- Examples:
  - Er ist früher permanent dieser Hyang- sook hinterhergelaufen.
...
### "-" + "teilen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Es hängt vollkommen von den Vorur- teilen deines Subjekts ab, verstehst du?

### "-" + "versen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Er hat das Profil eines Per- versen mit gregarischem Trieb.

### "-" + "verständlich" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Exzellenz macht sich Sorgen wegen Don Tancredi - verständlich.

### "-" + "viel" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Und sie bringt Geld mit - viel Geld.

### "-" + "vielen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Danke - vielen Dank.
...
- Actual: Space
- Examples:
  - Als wollte ich fliehen - vor der Sehnsucht, der Unschuld.

### "-" + "wahre" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Eine Familie von Helden seid ihr - wahre Helden.

### "-" + "warum" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Es gibt keinen Strom am Moment - warum?
...
- Actual: Space
- Examples:
  - Aber die geistig Blinden - wo werden die enden?

### "-" + "worden" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "/" + "avinho" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - F/avinho, Brauner zehn and Tafare/!
...
### "/" + "ienangehörige" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Fami/ienangehörige gehen bitte zu den Ausgängen.
...
- Actual: None
- Examples:
  - Um Da/va zu schützen, nahm ich das Feuer auf meine Kappe.
...
### "Abendmahl" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Leonardo da Vinci, der „Das letzte Abendmahl“ malte, war homosexuell.

### "Abschrecken" + "d" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Abschreckend sind in erster Linie Soldaten, die zu viel reden.

### "Achtung" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Achtung !
...
### "Amerika" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Europa, Amerika - und zurück.

### "Amerikas" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Bourbonen" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Den Bourbonen - falls es erlaubt ist, sie zu erwähnen.

### "Brasiliens" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Bristolian" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ein „Bristolian“ ist ein Einheimischer der Stadt Bristol.

### "Bristolians" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Cowboys" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du nennst sie „Mavericks“; ich nenne sie „Cowboys“.
...
### "Damit" + "du" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Damitdu für ihn sorgen kannst.
...
### "De Santis" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Was soll das, De Santis !

### "Deckung" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Deckung !
...
### "Drachen" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tom hat im „Goldenen Drachen“ gegessen.

### "Dreck" + "sau" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Drecksau!

### "Drei" + "stigkeit" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: Space
- Examples:
  - Mein Glück, meine Freiheit, meine Ehre - alles!

### "Eichhörnchen" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Sie gründeten eine Musikgruppe mit dem Namen „Die Eichhörnchen“.
...
### "Frie" + "de" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Friede sei mit dir.

### "Frieden“" + "lesen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "Gangschaltung" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Gabel, Gangschaltung - alles in allem ein Meisterstück.

### "Gatsby" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ich habe auf der Oberschule „Der große Gatsby“ gelesen.

### "Gegensätze" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die Gegensätze - Yin und Yang - streben nacheinander bis ans Ende der Zeit.
...
- Actual: Space
- Examples:
  - Wir sind Gefährten im Geist - wie ihr alle.
...
### "Herein" + "." (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Herein .

### "Herz" + "bube" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Herzbube?
...
### "Johannes’" + "Weigerung" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Tom und Maria hoffen auf Johannes’ Weigerung.

### "Johannes’" + "Wünsche" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "Kams" + "t" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Kamst du dann als Sünder zur Welt?

### "Katsuhiro" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Shichiroji, Katsuhiro - Westen!
...
### "Kleopatra" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wie schreibt man „Kleopatra“ in Hieroglyphen?

### "Klinge" + "In" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - KlingeIn Sie durch, wenn sie kommt.
...
### "Künst" + "ler" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Künstlerstadt.

### "Künste" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: None
- Examples:
  - Lächelnd wird die Politik des Landes diskutiert.
...
### "Mach" + "’ne" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Mach ’ne Fliege!

### "Mach" + "’nen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Mach ’nen Abflug!
...
- Actual: None
- Examples:
  - Tom verwendet im Internet den Namen „Maria“.

### "Mavericks" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du nennst sie „Mavericks“; ich nenne sie „Cowboys“.
...
### "Moroni" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wenn ich mich nicht irre, Sie haben das Moroni -Haus dekoriert?
...
### "Nord-" + "und" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die Grenze zwischen Nord- und Südkorea ist da hinten.

### "Nordkorea Zentralasiens" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: Space
- Examples:
  - Viel weicher als die von Seo-Rae - und das als Mann.
...
### "Richtlinien" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Lies bitte unsere „Regeln und Richtlinien“.

### "Riesen" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "Rund" + "um" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Rundumverteidigung!

### "Rupien" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Dreißig Rupien - Was!
...
### "Satelliten" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Satellitäh Satelliten - lassen Sie mich erklären.

### "Satzes" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Scheiß" + "Torpedos" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Diese ScheißTorpedos!

### "Schenck" + "." (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Schenck .

### "Schlagbass" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Schlagbass - Freddy Loyacano.

### "Schlange" + "…" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Eine unschuldige Schlange … - Judy, die Luchse sind Killer.
...
### "Schusswaffenvereinigung" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tom ist ein Mitglied der „Nationalen Schusswaffenvereinigung“.

### "Schwarze" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Alles Schwarze - mit Kanonen!
...
- Actual: None
- Examples:
  - Ich habe Tom als „fettes Schwein“ tituliert.

### "Schwuchtel" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Sagt weiter „Schwuchtel“, ja?

### "Schütte" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Na, Schütte - Keine Namen!
...
### "Sexismus" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Weißt du überhaupt, was „Sexismus“ bedeutet?

### "Sie" + "Jahre" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Sie nennen sich Generale, weil SieJahre auf Militärakademien zugebracht haben.
...
### "Situation" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Boldi befand sich in einer „hopfenlosen Situation“.

### "Sklave" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: None
- Examples:
  - Du solltest dich für die Stadtverordneten­versammlung zur Wahl stellen.
...
### "Tancredi" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Exzellenz macht sich Sorgen wegen Don Tancredi - verständlich.

### "Tanz" + "t" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tanzt du, Cabiria?
...
### "Tooney" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Max Tooney - Trompete.

### "Traudl" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Traudl !
...
### "Trevor" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Gott, Trevor - was ist los?

### "Trikolore" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die Trikolore - äh!
...
### "Tsubasa" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Der „Tsubasa“ ist ein sehr schneller Zug.

### "Tucker" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ja, Sir, ja, Sir, Mister Tucker - Motherfucker!

### "Tun" + "wird" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Unternehmensengel" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Maria betätigt sich als „Unternehmensengel“.

### "Unterrichten" + "." (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Und der Platz,den wir Sie anbieten ist genug für das Unterrichten .
...
### "VERSAGT" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - SYSTEM VERSAGT - Ich kenne die Zukunft nicht.

### "Vater" + "war" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Mein Vaterwar Buchhalter.
...
### "Vielfältigkeiten" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Das sind zu viele „Vielfältigkeiten“, Chris.

### "Violine" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Violine - Phil Douglas.
...
- Actual: Space
- Examples:
  - Sie hätten anrufen sollen Der Vize -Kader, kein Mord.

### "Volltreffer" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Volltreffer !
...
### "Wen" + "rs" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wenrs blöd wird, bist du Schuld!
...
### "William" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Da triffst du Prinz William - und kannst ihn an seiner Stelle heiraten.

### "Wir" + "wollen" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wirwollen hier raus!

### "Wir" + "wollten" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
### "Währungsfonds" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - IWF steht für „Internationaler Währungsfonds“.
...
### "Zurücktreten" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Zurücktreten !

### "Zusammenreißen" + "!" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Zusammenreißen !
...
### "auf" + "jeden" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wenn wir bleiben, kriegen uns die Russen aufjeden Fall!
...
### "auf" + "’nen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Lust auf ’nen Tee?

### "auf" + "’ner" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich hab’ ihn mal auf ’ner Feier gesehen.

### "aufwachen" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Das Gegenteil von „aufwachen“ ist „einschlafen“.
...
### "bestückt" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Deshalb ist sie nicht bestückt - und wir schlagen gerade zurück.
...
### "der" + "junge" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wo ist derjunge Mann?

### "deutlich" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: None
- Examples:
  - Ich kann mir nur zugute halten, dieJuden offen bekämpft zu haben.
...
### "die" + "jungen" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Aber dafür sind diejungen Leute doch da.
...
### "dreizehn" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Hast du „dreizehn“ oder „dreißig“ gesagt?

### "dreißig" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Hast du „dreizehn“ oder „dreißig“ gesagt?
...
- Actual: Space
- Examples:
  - Wann wurde Agrippa ermordet ?

### "erschrecken" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Sie wollten sie nur erschrecken - und dann ging die Waffe los.
...
### "gedacht" + "und" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Also, zuerst haben wir an Paris gedachtund dann an den Balaton.
...
### "geht" + "jeden" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Er gehtjeden Morgen eine Stunde spazieren.

### "geht" + "jetzt" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Das gehtjetzt nicht.
...
### "gewinnt" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Tom gewinnt nie bei „Drei gewinnt“.

### "gewonnen" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wettbewerbe damit gewonnen - solche Sachen.
...
- Actual: Space
- Examples:
  - Das ist gut -ich komme bald zurück.
...
- Actual: None
- Examples:
  - Wir habenkein Interesse an dem Geld, das eventuell in dem Haus gefunden wurde.

### "hab’" + "dich" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich hab’ dich einfach sehr gern.

### "hab’" + "ein" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich hab’ ein Sofa.

### "hab’" + "einen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich hab’ einen Narren an der gefressen.

### "hab’" + "ihn" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich hab’ ihn mal auf ’ner Feier gesehen.
...
### "ihr" + "jeden" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Wenn ihr flieht, habt ihrjeden Waffennarren in den USA auf den Fersen.

### "in" + "’nem" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "irgend" + "etwas" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Er hat noch nie auf irgendetwas anderem geschrieben.

### "irgend" + "wer" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
...
- Actual: Space
- Examples:
  - Er denkt, Deine Mutter ist ’ne heiße Nummer.
...
### "kostet" + "ja" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Fragen kostetja nichts.

### "kostet" + "’ne" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Was kostet ’ne Kiste Bier?

### "kämpfen" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ein Falconeri sollte auf unserer Seite kämpfen - für den König.

### "kämpfst" + "jetzt" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du kämpfstjetzt mit unserem Priester?
...
### "mal" + "’ne" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Haste mal ’ne Kippe?

### "mal" + "’nen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: Space
- Examples:
  - Er reiste - und jedes Mal an einen anderen Ort.
...
### "sagst" + "ja" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Du sagstja selber immer, was du denkst.

### "sagt" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Das Evangelium sagt -Oh, ja!
...
### "schaffst" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wenn du das nicht schaffst - bin ich erledigt.

### "schaff’" + "ich" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "singen" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Und wenn die Meise nicht will singen - Alle raus.

### "so" + "’nen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "und" + "-abgabe" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Momentan ist die Leistungsaufnahme und -abgabe zufriedenstellend.
...
### "und" + "jeder" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ich kanntejeden, undjeder kannte mich.
...
### "variabel" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - In der heutigen Zeit ist „variabel“ ein Schimpfwort.
...
### "verweht" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Hast du schon einmal „Vom Winde verweht“ gelesen?

### "verzeihe" + "-" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Oh dumme Frage, verzeihe - kein verzeihe.
...
- Actual: Space
- Examples:
  - Weil ihr gleich neue beste Buddies seid von … Nibbles Maplestick!
...
- Actual: Space
- Examples:
  - Die in jener Nacht unterwegs war -Oh, ja!
...
- Actual: Space
- Examples:
  - Wer weiß - das könnte euer Glückstag sein!
...
### "wenn" + "n" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ich kann es nicht wissen, wennn du es mir nicht sagst.
...
### "werdet" + "jetzt" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Lhr werdetjetzt als Verräter an eurem Vaterland betrachtet.

### "wie" + "’ne" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "wir" + "ja" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Jetzt können wirja nicht einfach so ohne ein letztes Word verschwinden, hmm?
...
### "wir" + "jemand" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Haben wirjemand unten?
...
### "zurücksetzen" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Hast du auf „zurücksetzen“ gedrückt?
...
- Actual: Space
- Examples:
  - Hey, ähm … Ich hab was für dich.

### "​​" + "für" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Man könnte die Bausteine ​​für neues Leben schaffen.

### "​​​​" + "verbunden" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Halten Sie Ihre Steine ​​​​verbunden.

### "—" + "Kompanie" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - VW werden Sie in die C—Kompanie eingliedern.
...
### "“" + "Kontakt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich halte zu meinen Freunden und Verwandten über „Facebook“ Kontakt.

### "“" + "aufgeführt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Im Theater wird „Romeo und Julia“ aufgeführt.

### "“" + "befindet" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Das „ovale Büro“ befindet sich im Weißen Haus.

### "“" + "bekannt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die Stadt Recife ist als „Venedig Brasiliens“ bekannt.
...
### "“" + "gebaut" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Tom und Maria haben ein „Erdschiff“ gebaut.

### "“" + "gedrückt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Hast du auf „zurücksetzen“ gedrückt?
...
### "“" + "handelt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Bei „ich“, „sie“ und „wir“ handelt es sich um Personalpronomen.

### "“" + "herabgewürdigt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Frauen werden in vielen Liedern des Genres „Rap“ herabgewürdigt.
...
### "“" + "schlitterten" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die „Riesen“ schlitterten der Niederlage entgegen.

### "“" + "sendet" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die „Stimme Amerikas“ sendet aus Washington.
...
### "“" + "tituliert" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich habe Tom als „fettes Schwein“ tituliert.

### "“" + "umgehen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Tom kann recht gut mit „Photoshop“ umgehen.
...
- Actual: None
- Examples:
  - Dann zähle ich bis drei und drücke auf „Enter”.
...
- Actual: None
- Examples:
  - Irgendein „Kaninchenbau”-Blödsinn, den du in der Times gelesen hast?
...
### "„" + "Silizium" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Am „Silizium-Kreisel“ sind zahlreiche junge IT-Unternehmen ansässig.

### "„" + "Stimme" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Die „Stimme Amerikas“ sendet aus Washington.
...
### "„" + "fettes" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Ich habe Tom als „fettes Schwein“ tituliert.

### "„" + "hopfenlosen" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Boldi befand sich in einer „hopfenlosen Situation“.
...
### "„Anime“" + "genannt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Er mochte Zeichentrickfilme japanischer Art, auch „Anime“ genannt.

### "„City“" + "oder" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Bist du für „City“ oder die „Rovers“?

### "„Clearasil" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Oliver benützt „Clearasil“.

### "„Cosa Nostra“" + "bezeichnet" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die Mafia wird auch als die „Cosa Nostra“ bezeichnet.

### "„Eins“" + "für" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Ich habe eine „Eins“ für meinen Aufsatz bekommen.

### "„Frankfurter" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - In seinem Herkunftsland Deutschland hieß der Hot Dog „Frankfurter“.

### "„Hindenburg“" + "ging" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Die „Hindenburg“ ging plötzlich in Flammen auf.

### "„JUMP“" + "eingestellt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
- Actual: None
- Examples:
  - An der Tür war ein großes T für „Toilette“.

### "„Tom“" + "und" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Der Satz enthält zwei Subjekte, nämlich „Tom“ und „Mary“.

### "„Trumpete" + "“" (1 occurrences)
- Predicted: Space
- Actual: None
- Examples:
  - Clinton kann Saxophon spielen und Trump die „Trumpete“.

### "„Twitter“" + "folgen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Man kann dem Papst jetzt auf „Twitter“ folgen.

### "„Verstecken“" + "gespielt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Wir haben nur „Verstecken“ gespielt.

### "„Wirtschaft“" + "und" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "„ausreichend“" + "bekommen" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Du hast ein „ausreichend“ bekommen.
...
### "„schuldig“" + "plädieren" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
...
### "„zurücksetzen“" + "gedrückt" (1 occurrences)
- Predicted: None
- Actual: Space
- Examples:
  - Haben Sie auf „zurücksetzen“ gedrückt?
